...
export const SKILLS: Record<string, Skill> = {
    ...
    MEDITRA: { id: 'MEDITRA', name: 'Media', cost: 10, element: Element.PHYS, power: -30, targetType: 'ALL' },
};
