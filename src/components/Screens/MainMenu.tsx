...
export const MainMenu: React.FC<MainMenuProps> = ({ onPlay, onTeam, onAchievements }) => {
    return (
        <div className="h-screen w-full bg-yellow-400 relative overflow-hidden flex flex-col items-center justify-center">
            ...
            <div className="z-10 flex flex-col items-center gap-8">
                <div
                    className="text-6xl md:text-9xl font-display font-black italic text-black tracking-tighter transform -rotate-6 drop-shadow-lg mb-8"
                ...
                <div className="flex flex-col gap-4 items-center w-full max-w-md">
                    ...
                    >
                         <div className="flex items-center justify-center gap-2 transform skew-x-12">
                            <Trophy className="fill-current" /> AWARDS
                        </div>
                    </button>
                </div>
            </div>
