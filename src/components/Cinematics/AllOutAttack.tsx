    ...
    return (
        <div className="absolute inset-0 z-50 bg-yellow-400 flex items-center justify-center overflow-hidden">
             ...
             <div className="relative z-10 transform -rotate-6 text-center">
                 <h1 className="text-6xl md:text-9xl leading-none font-display text-black italic drop-shadow-[4px_4px_0px_rgba(255,255,255,1)] md:drop-shadow-[10px_10px_0px_rgba(255,255,255,1)] animate-scale-in">
                     DUSTED!
                 </h1>
